...
public class TestSuite extends BaseTest {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        checkoutPage.sendFirstName("Prime");
        checkoutPage.sendLastName("Tester");
        checkoutPage.sendEmail("primetester");
        checkoutPage.selectCountryName("United States");
        checkoutPage.selectStateName("Alaska");
        checkoutPage.sendCityName("City XYZ");
        checkoutPage.sendAddressName("1 XYZ Street");
        checkoutPage.sendPostCode("AB78CD");
        checkoutPage.sendPhoneNumber("56787575486");
